...
class JobFilterIndexController(object):
    """
    ...
    @retryOperation
    def index(self):
        query = request.context.get('query', Job.query)
...
class JobFilterController(JobFilterIndexController):
...
class DescriptionsController(JobFilterController):
    def get_subquery(self, query):
        return query.values(Job.description)

    def get_lookup_controller(self):
        return DescriptionController

class DescriptionController(JobFilterIndexController):
    def get_subquery(self, query):
